package com.example.questapi_215.view
...
import com.example.questapi_215.R
import com.example.questapi_215.modeldata.DataSiswa
import com.example.questapi_215.uicontroller.route.DestinasiHome
import com.example.questapi_215.viewmodel.HomeViewModel
import com.example.questapi_215.viewmodel.provider.PenyediaViewModel
import com.example.questapi_215.viewmodel.StatusUiSiswa
    ...
    Column(
        ...
        when (statusUiSiswa) {
            ...
            is StatusUiSiswa.Success -> {
                // TAMBAHAN: Semak jika list kosong
                if (statusUiSiswa.siswa.isEmpty()) {
                    Box(
                        modifier = Modifier.fillMaxSize(),
                        contentAlignment = Alignment.Center
                    ) {
                        Text(text = "Tiada data siswa. Sila tambah data baru.")
                    }
                } else {
                    DaftarSiswa(
...
fun LoadingScreen(modifier: Modifier = Modifier) {
    Box(
        ...
        // Gunakan CircularProgressIndicator sebagai ganti loading_img yang hilang
